...
trait AllowDD
    fun Tag<AllowDD>.dd(c: StyleClass? = null, id: String? = null, contents: TagWithText<DD>.() -> Unit = empty_contents) = contentTag(::DD, "dd", c, id, contents)

trait AllowDT
    fun Tag<AllowDT>.dt(c: StyleClass? = null, id: String? = null, contents: TagWithText<DT>.() -> Unit = empty_contents) = contentTag(::DT, "dt", c, id, contents)
...
trait CommonAllow: AllowH1, AllowH2, AllowH3, AllowH4, AllowH5, AllowH6
    fun Tag<CommonAllow>.a(c: StyleClass? = null, id: String? = null, contents: TagWithText<A>.() -> Unit = empty_contents) = contentTag(::A, "a", c, id, contents)
    ...
    fun Tag<CommonAllow>.b(c: StyleClass? = null, id: String? = null, contents: TagWithText<B>.() -> Unit = empty_contents) = contentTag(::B, "b", c, id, contents)
    ...
    fun Tag<CommonAllow>.br(c: StyleClass? = null, id: String? = null, contents: Tag<BR>.() -> Unit = empty_contents) = contentTag(::BR, "br", c, id, contents)
    ...
    fun Tag<CommonAllow>.em(c: StyleClass? = null, id: String? = null, contents: TagWithText<EM>.() -> Unit = empty_contents) = contentTag(::EM, "em", c, id, contents)
    ...
    fun Tag<CommonAllow>.hr(c: StyleClass? = null, id: String? = null, contents: Tag<HR>.() -> Unit = empty_contents) = contentTag(::HR, "hr", c, id, contents)
    fun Tag<CommonAllow>.i(c: StyleClass? = null, id: String? = null, contents: TagWithText<I>.() -> Unit = empty_contents) = contentTag(::I, "i", c, id, contents)
    ...
    fun Tag<CommonAllow>.img(c: StyleClass? = null, id: String? = null, contents: Tag<IMG>.() -> Unit = empty_contents) = contentTag(::IMG, "img", c, id, contents)
    fun Tag<CommonAllow>.input(c: StyleClass? = null, id: String? = null, contents: Tag<INPUT>.() -> Unit = empty_contents) = contentTag(::INPUT, "input", c, id, contents)
    ...
    fun Tag<CommonAllow>.small(c: StyleClass? = null, id: String? = null, contents: TagWithText<SMALL>.() -> Unit = empty_contents) = contentTag(::SMALL, "small", c, id, contents)
    fun Tag<CommonAllow>.span(c: StyleClass? = null, id: String? = null, contents: TagWithText<SPAN>.() -> Unit = empty_contents) = contentTag(::SPAN, "span", c, id, contents)
    fun Tag<CommonAllow>.strong(c: StyleClass? = null, id: String? = null, contents: TagWithText<STRONG>.() -> Unit = empty_contents) = contentTag(::STRONG, "strong", c, id, contents)
